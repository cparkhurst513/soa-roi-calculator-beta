...
const SOA_LOGO_URL =
  "https://cdn.shopify.com/s/files/1/0681/4295/6773/files/Speed_of_Air_TT_2_black.png?v=1778284738";
    ...
    <div className="space-y-1.5">
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`h-11 w-full rounded-xl border border-slate-200 bg-white px-3 text-base shadow-sm outline-none transition focus:border-[#2C8DCD] focus:ring-2 focus:ring-[#2C8DCD]/20 ${
            prefix ? "pl-7" : ""
          } ${suffix ? "pr-16" : ""}`}
        />
...
export default function App() {
  ...
  const results = useMemo(() => {
    ...
    const oilSavings = servicesAvoided * oilVolumeGal * oilCost;
    const laborSavings = servicesAvoided * laborHours * laborRate;
    const recoveredProductionValue = servicesAvoided * downtimeHours * productiveHourValue;
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="rounded-3xl border border-slate-200 bg-white p-4 shadow-sm sm:p-6">
            ...
            {tab === "investment" && (
              <div className="mt-5 space-y-4">
                <Field label="SoA upgrade cost" value={inputs.soaUpgradeCost} onChange={set("soaUpgradeCost")} prefix="$" helper="Incremental premium at rebuild or overhaul. Internal sales-use only." />
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-4 shadow-sm sm:p-5">
              <p className="text-xs leading-5 text-slate-500">
                Beta sales-use calculator. Estimates only. Actual results vary by duty cycle, fuel quality, load factor, maintenance practices, emissions program valuation, and engine condition.
              </p>
            </div>
          </div>
        </div>
